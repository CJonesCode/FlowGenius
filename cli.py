...
app.command("list", help="List all bug reports with optional filtering")(list.list_issues)
app.command("show", help="Show detailed information about a specific bug report")(show.show)
