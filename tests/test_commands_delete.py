...
class TestDeleteCommand:
    ...
    def test_delete_by_uuid_with_force_json_output(self):
        ...
        with patch('core.storage.load_issue', return_value=sample_issue) as mock_load, \
             patch('core.storage.delete_issue', return_value=True) as mock_delete:
    ...
    def test_delete_by_index_with_force_json_output(self):
        ...
        with patch('core.storage.get_issue_by_index', return_value=sample_issue) as mock_get, \
             patch('core.storage.delete_issue', return_value=True) as mock_delete:
    ...
    def test_delete_with_pretty_flag_and_force(self):
        ...
        with patch('core.storage.load_issue', return_value=sample_issue) as mock_load, \
            ...
            result = self.runner.invoke(app, ["delete", "pretty123", "--pretty", "--force"])
    ...
    def test_delete_with_pretty_flag_no_force_confirmed(self):
        ...
        with patch('core.storage.load_issue', return_value=sample_issue) as mock_load, \
            ...
            mock_confirm.assert_called_once_with("Are you sure you want to delete this issue?")
    ...
    def test_delete_with_pretty_flag_no_force_cancelled(self):
        ...
        with patch('core.storage.load_issue', return_value=sample_issue) as mock_load, \
             patch('core.storage.delete_issue') as mock_delete, \
    ...
    def test_delete_storage_error_json_mode(self):
        ...
        with patch('core.storage.load_issue', return_value=sample_issue), \
             patch('core.storage.delete_issue', side_effect=StorageError("File not found")):
    ...
    def test_delete_storage_error_pretty_mode(self):
        ...
        with patch('core.storage.load_issue', return_value=sample_issue), \
             patch('core.storage.delete_issue', side_effect=StorageError("Permission denied")):
            
            result = self.runner.invoke(app, ["delete", "error456", "--pretty", "--force"])
    ...
    def test_delete_issue_not_found_pretty_mode(self):
        ...
        with patch('core.storage.load_issue', side_effect=StorageError("Issue not found")):
            ...
            result = self.runner.invoke(app, ["delete", "missing456", "--pretty", "--force"])
    ...
    def test_delete_invalid_index_error(self):
        ...
        with patch('core.storage.get_issue_by_index', side_effect=StorageError("Invalid index")):
    ...
    def test_delete_unexpected_error_json_mode(self):
        ...
        with patch('core.storage.load_issue', return_value=sample_issue), \
             patch('core.storage.delete_issue', side_effect=Exception("Unexpected error")):
    ...
    def test_delete_unexpected_error_pretty_mode(self):
        ...
        with patch('core.storage.load_issue', return_value=sample_issue), \
             patch('core.storage.delete_issue', side_effect=Exception("Database error")):
            
            result = self.runner.invoke(app, ["delete", "unexpected456", "--pretty", "--force"])
    ...
    def test_delete_by_index_edge_cases(self):
        ...
        for index_str, expected_index in test_cases:
            ...
            with patch('core.storage.get_issue_by_index', return_value=sample_issue) as mock_get, \
                 patch('core.storage.delete_issue', return_value=True):
    ...
    def test_delete_unexpected_exception_json_mode(self, temp_dir, mock_config):
        ...
        with patch('commands.delete.storage.load_issue') as mock_load:
            ...
            mock_load.side_effect = RuntimeError("This will trigger general exception handler")
            ...
            assert output["success"] is False
            assert "Unexpected error: This will trigger general exception handler" in output["error"] 