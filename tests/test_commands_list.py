...
class TestListCommand:
    ...
    def test_filter_by_severity_pretty_output(self):
        ...
        with patch('core.storage.list_issues', return_value=self.sample_issues):
            result = self.runner.invoke(app, ["list", "--severity", "medium", "--pretty"])
    ...
    def test_filter_by_both_tag_and_severity(self):
        ...
        with patch('core.storage.list_issues', return_value=self.sample_issues):
            result = self.runner.invoke(app, ["list", "--tag", "ui", "--severity", "low"])
    ...
    def test_storage_error_handling_json_mode(self):
        ...
        with patch('core.storage.list_issues', side_effect=StorageError("Storage failed")):
            result = self.runner.invoke(app, ["list"])
    ...
    def test_unexpected_error_handling(self):
        ...
        with patch('core.storage.list_issues', side_effect=Exception("Unexpected error")):
            result = self.runner.invoke(app, ["list"])
