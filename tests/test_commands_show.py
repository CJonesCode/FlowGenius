...
class TestShowCommand:
    ...
    def test_show_by_uuid_json_output(self):
        ...
        with patch('core.storage.load_issue', return_value=self.sample_issue) as mock_load:
    ...
    def test_show_by_index_json_output(self):
        ...
        with patch('core.storage.get_issue_by_index', return_value=self.sample_issue) as mock_get:
    ...
    def test_show_issue_not_found_json_mode(self):
        ...
        with patch('core.storage.load_issue', side_effect=StorageError("Issue not found: missing123")):
    ...
    def test_show_issue_not_found_pretty_mode(self):
        ...
        with patch('core.storage.load_issue', side_effect=StorageError("Issue not found: missing456")):
    ...
    def test_show_invalid_index_pretty_mode(self):
        ...
        with patch('core.storage.get_issue_by_index', side_effect=StorageError("Index out of range: 0")):
