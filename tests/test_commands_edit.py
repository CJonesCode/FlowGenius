...
class TestEditCommand:
    ...
    def test_edit_title_by_uuid_json_output(self):
        ...
        with patch('core.storage.load_issue', return_value=self.sample_issue.copy()) as mock_load, \
             patch('core.schema.validate_or_default', return_value=self.sample_issue.copy()) as mock_validate, \
             patch('core.storage.save_issue') as mock_save:
            
            result = self.runner.invoke(app, ["edit", "test123", "--title", "New Title"])
    ...
    def test_edit_title_by_index_pretty_output(self):
        ...
        with patch('core.storage.get_issue_by_index', return_value=self.sample_issue.copy()) as mock_get, \
             patch('core.schema.validate_or_default', return_value=self.sample_issue.copy()) as mock_validate, \
             patch('core.storage.save_issue') as mock_save:
            
            result = self.runner.invoke(app, ["edit", "1", "--title", "Pretty New Title", "--pretty"])
    ...
    def test_edit_severity_valid_values(self):
        ...
        for severity in valid_severities:
            with patch('core.storage.load_issue', return_value=self.sample_issue.copy()) as mock_load, \
                ...
                result = self.runner.invoke(app, ["edit", "test123", "--severity", severity])
    ...
    def test_edit_severity_case_insensitive(self):
        ...
        for input_severity, expected_severity in test_cases:
            with patch('core.storage.load_issue', return_value=self.sample_issue.copy()) as mock_load, \
                ...
                result = self.runner.invoke(app, ["edit", "test123", "--severity", input_severity])
    ...
    def test_edit_severity_invalid_value_json_mode(self):
        ...
        with patch('core.storage.load_issue', return_value=self.sample_issue.copy()):
            result = self.runner.invoke(app, ["edit", "test123", "--severity", "invalid"])
    ...
    def test_edit_severity_invalid_value_pretty_mode(self):
        ...
        with patch('core.storage.load_issue', return_value=self.sample_issue.copy()):
            result = self.runner.invoke(app, ["edit", "test123", "--severity", "urgent", "--pretty"])
    ...
    def test_edit_add_tag_existing_tag(self):
        ...
        with patch('core.storage.load_issue', return_value=self.sample_issue.copy()) as mock_load, \
            ...
            result = self.runner.invoke(app, ["edit", "test123", "--add-tag", "original"])
    ...
    def test_edit_remove_tag_existing_tag(self):
        ...
        with patch('core.storage.load_issue', return_value=self.sample_issue.copy()) as mock_load, \
            ...
            result = self.runner.invoke(app, ["edit", "test123", "--remove-tag", "original"])
    ...
    def test_edit_remove_tag_nonexistent_tag(self):
        ...
        with patch('core.storage.load_issue', return_value=self.sample_issue.copy()) as mock_load, \
            ...
            result = self.runner.invoke(app, ["edit", "test123", "--remove-tag", "nonexistent"])
    ...
    def test_edit_storage_error_json_mode(self):
        ...
        with patch('core.storage.load_issue', side_effect=StorageError("Issue not found")):
            result = self.runner.invoke(app, ["edit", "missing123", "--title", "New Title"])
    ...
    def test_edit_storage_error_pretty_mode(self):
        ...
        with patch('core.storage.load_issue', side_effect=StorageError("Permission denied")):
            result = self.runner.invoke(app, ["edit", "test123", "--title", "New Title", "--pretty"])
    ...
    def test_edit_validation_error_json_mode(self):
        ...
        with patch('core.storage.load_issue', return_value=self.sample_issue.copy()), \
             patch('core.schema.validate_or_default', side_effect=ValidationError("Invalid data")):
    ...
    def test_edit_validation_error_pretty_mode(self):
        ...
        with patch('core.storage.load_issue', return_value=self.sample_issue.copy()), \
             patch('core.schema.validate_or_default', side_effect=ValidationError("Invalid format")):
    ...
    def test_edit_save_error_json_mode(self):
        ...
        with patch('core.storage.load_issue', return_value=self.sample_issue.copy()), \
             patch('core.schema.validate_or_default', return_value=self.sample_issue.copy()), \
             patch('core.storage.save_issue', side_effect=StorageError("Disk full")):
    ...
    def test_edit_invalid_index_error(self):
        ...
        with patch('core.storage.get_issue_by_index', side_effect=StorageError("Invalid index: 999")):
    ...
    def test_edit_issue_without_tags_field(self):
        ...
        with patch('core.storage.load_issue', return_value=issue_without_tags) as mock_load, \
             patch('core.schema.validate_or_default', return_value=issue_without_tags) as mock_validate, \
             patch('core.storage.save_issue') as mock_save:
            
            result = self.runner.invoke(app, ["edit", "notags123", "--add-tag", "firsttag"])
    ...
    def test_edit_tag_operations_edge_cases(self):
        ...
        with patch('core.storage.load_issue', return_value=self.sample_issue.copy()) as mock_load, \
            ...
            result = self.runner.invoke(app, ["edit", "test123", "--add-tag", "tag with spaces"])
