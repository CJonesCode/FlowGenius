...
Be concise but descriptive. Focus on the core issue."""
        ...
        try:
            ...
            processed_result = validate_and_clean_result(result, state.input_description)
...
def validate_and_clean_result(result: Dict[str, Any], original_description: str) -> Dict[str, Any]:
    ...
    if not title or len(title) == 0:
        ...
        title = sentences[0].strip() if sentences and sentences[0].strip() else 'Untitled Issue'
